...
class WebTestCase(unittest.TestCase):
    ...
    def test_page_search(self):
        ...
        try:    
            ...
            self.search_box = self.driver.find_element(By.XPATH, '/html/body/div/div/main/div/div/div/div/div/div[1]/div[2]/div/div/div/div/input')
            self.search_box.send_keys('0800000000')

            textbox_element = self.driver.find_element(By.XPATH, "/html/body/div/div/main/div/div/div/div/div/div[1]/div[2]/div/div/div/div/input")  
            ...
            Check_Number = self.driver.find_element(By.XPATH, '//*[@class="MuiTableBody-root mui-style-1xnox0e"]//tr//td[5]')
