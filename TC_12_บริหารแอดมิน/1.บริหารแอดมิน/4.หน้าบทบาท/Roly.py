...
# เลือกผู้ใช้งาน
        ...
        select_user = WebDriverWait(self.driver, 10).until(
...
# จัดการเลือกโครงการ 
        ...
        # button1 = self.driver.find_element(By.XPATH, '/html/body/div[3]/div[3]/ul/li[1]')
        # self.assertTrue(button.is_displayed(), "ปุ่มไม่แสดงอยู่บนหน้า")
        # self.assertTrue(button.is_enabled(), "ปุ่มไม่สามารถใช้งานได้")
        # button1.click()
        # time.sleep(1)
...
# Save
        # click = self.driver.find_element(By.XPATH, '/html/body/div/div/main/div/div/div/form/div/div/div[3]/table/tbody/tr/td[1]/div/div/div/div') 
        # click.click()
