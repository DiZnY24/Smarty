...
def page_approved(driver):
# *** เปิดหน้า รายชื่อคนลงทะเบียน (อนุมัติ)***        

        try:
            driver.get('https://msm-smarty-cms-staging.hr-impact.co/pre-register/approved')
            driver.implicitly_wait(10)
            time.sleep(0.3)
            
            wait_element = WebDriverWait(driver, 30).until(
                EC.visibility_of_element_located((By.XPATH, '/html/body/div/div/main/div/div/div/div[2]/div/div/div[2]/div[2]/div/div/div/div[1]/div[2]'))
            )
            print('Wait page Show Webstie : Pass')

            # คลิกเลือกตึก
            
            select_building = WebDriverWait(driver, 30).until(
                EC.element_to_be_clickable((By.XPATH, 
            '/html/body/div/div/main/div/div/div/div[1]/div/div[1]/div/div/div/div')) 
            )
            ...
            select_building = WebDriverWait(driver, 10).until(
                EC.element_to_be_clickable((By.XPATH, 
            '/html/body/div/div/main/div/div/div/div[1]/div/div[1]/div/div/div/div/input')) # คลิกขอ เข้าสู่ระบบ
            )
            assert select_building.is_displayed(), 'Element is not displayed!'
            select_building.send_keys('อาคาร C1' + Keys.ARROW_DOWN + Keys.ENTER + Keys.ESCAPE)

            input_key = driver.find_element(By.XPATH, 
            '/html/body/div/div/main/div/div/div/div[1]/div/div[1]/div/div/div/div/input')
            ...
            floor_room = WebDriverWait(driver, 10).until(
                EC.element_to_be_clickable((By.XPATH, 
            '/html/body/div/div/main/div/div/div/div[1]/div/div[2]/div[1]/div/div/div/div/div[2]/div/div')) 
            )
            assert floor_room.is_displayed(), 'Element is not displayed!'
            assert floor_room.is_enabled(), 'Element is not enabled!'
            floor_room.click()

            wait_element = WebDriverWait(driver, 15).until(
                EC.element_to_be_clickable((By.XPATH, '/html/body/div/div/main/div/div/div/div[1]/div/div[2]/div[1]/div/div/div/div/div[2]/div/div/input'))
            )
            print('flooo-room Key : Pass')

            floor_room = WebDriverWait(driver, 10).until(
                EC.element_to_be_clickable((By.XPATH, 
            '/html/body/div/div/main/div/div/div/div[1]/div/div[2]/div[1]/div/div/div/div/div[2]/div/div/input')) 
            )
            assert floor_room.is_displayed(), 'Element is not displayed!'
            ...
            Search_by_name = WebDriverWait(driver, 10).until(
                EC.element_to_be_clickable((By.XPATH, 
            '/html/body/div/div/main/div/div/div/div[1]/div/div[2]/div[2]/div/div/div[2]/div/div/input')) 
            )
            assert Search_by_name.is_displayed(), 'Element is not displayed!'
            Search_by_name.send_keys('0971498936' + Keys.ARROW_DOWN + Keys.ENTER)
            
            # คลิกวันที่สร้าง 

            date = WebDriverWait(driver, 10).until(
                EC.element_to_be_clickable((By.XPATH, 
            '/html/body/div/div/main/div/div/div/div[1]/div/div[2]/div[3]/div[1]/div/div')) 
            )
            ...
            date = WebDriverWait(driver, 10).until(
                EC.element_to_be_clickable((By.XPATH, 
            '/html/body/div/div/main/div/div/div/div[1]/div/div[2]/div[3]/div[2]/div/div')) 
            )
            assert date.is_displayed(), 'Element is not displayed!'
            assert date.is_enabled(), 'Element is not enabled!'
            date.click()
            ...
            Role = WebDriverWait(driver, 10).until(
                EC.element_to_be_clickable((By.XPATH, 
            '/html/body/div/div/main/div/div/div/div[1]/div/div[2]/div[4]/div/div[2]/div/div/div')) 
            )
            ...
            '//div/div/div/div[2]/div/div/div[2]/div[2]/div/div/div/div[1]/div[1]'))
            )
